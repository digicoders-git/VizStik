        ...
        <table className="w-full">
          ...
          >
            <tr>
              ...
              <th
                className="px-4 py-3 text-left text-sm font-semibold border-b cursor-pointer hover:bg-opacity-50 transition-colors"
                onClick={handleSort}
                style={{
                  color: colors.text,
                  borderColor: colors.accent + "30",
      ...
      {!loading && totalPages > 1 && (
        ...
        >
          <div className="text-sm">
            ...
            {Math.min(currentPage * limit, totalShops)} of {totalShops} entries
          </div>
          <div className="flex items-center gap-2">
            <button
