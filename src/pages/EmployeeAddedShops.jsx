...
import { MdArrowBack, MdStore, MdPerson, MdPhone, MdLocationOn, MdEmail } from 'react-icons/md'
          ...
          <table className="w-full">
            ...
            <tbody>
              {employee.addedShops && employee.addedShops.length > 0 ? (
                employee.addedShops.map((shop, index) => (
                  <tr 
                    key={shop._id || index}
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm">
                      <button
                        ...
                        className="px-3 py-1 rounded-lg text-xs font-medium border transition-colors hover:bg-opacity-80"
                        style={{ 
